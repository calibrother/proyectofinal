...
if ($_SESSION['ventas']==1 || $_SESSION['cliente']==1)
{
...
switch ($_GET["op"]){
	...
	case 'listar':
		...
		if ($_SESSION['ventas']==0 && $_SESSION['cliente']==1)
		{
		$rspta=$venta->listarC($_SESSION['nombre']);
 		//Vamos a declarar un array
 		$data= Array();
	...
	case 'selectCliente'://COMO BOX DEL CLIENTE
